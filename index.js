...
const VPEDIA_BASE_URL = "https://v-pedia.web.id/h2h";

app.use(express.json());
app.use(express.static(path.join(__dirname, 'public')));

const mongoURI = 'mongodb+srv://cukimay:cukimay@cluster0.rhjoaem.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0';
